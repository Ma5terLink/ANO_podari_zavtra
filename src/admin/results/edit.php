            ...
            <div class="postsGrid">
                <div class="newsGrid__column">
                    ...
                    <input type="hidden" value="<?=$id?>" name="id">
                        ...
                        <div class="nBottom">
                            <div class="nImg">
                                <?php if($img != 'foto-no.svg'): ?>
                                        <img id="previewIMG" src="<?php echo BASE_URL."assets/img/results/".$img?>" alt="nImg">
                                    <?php else: ?>
                        ...
                        <div class="nFile">
                            <input value="<?=$img?>" type="file" id="titleImgFile" name="results-titleImgFile" accept=".png,.jpg,.jpeg,.svg,.bmp,.ico">
